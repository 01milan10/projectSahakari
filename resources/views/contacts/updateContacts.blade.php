                    ...
                    <div class='col-md-10'>
                        <div class="card card-info">
                            ...
                            <form action="{{route('update.contacts',['id'=>$contact->id])}}" class="form-image-upload" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div>
                                        <label for="location"></label><input type="text" id="location" class="form-control mb-4 @error('title') is-invalid @enderror" value="{{$contact->location}}" name="location" required autocomplete="location" autofocus>
                                    </div>
                                    <div>
