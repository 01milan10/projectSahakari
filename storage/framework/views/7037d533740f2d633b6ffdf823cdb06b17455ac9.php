...
unset($__errorArgs, $__bag); ?>" placeholder="Title" name="title" required autocomplete="title" autofocus>
                                    ...
                                    <div>
                                        <label for="category"></label><input type="text" id="category" class="form-control mb-4 <?php $__errorArgs = ['category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Category" name="category" required autocomplete="category">
                                    </div>
                                    <div>
                                        <input type="file" id="file" name="image" class="form-control mb-4 <?php $__errorArgs = ['file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Select an image to upload." required autocomplete="file">
                                    </div>
                            </div>
